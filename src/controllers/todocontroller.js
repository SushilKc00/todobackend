...
var todoschema_1 = require("../models/todoschema");
var getTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var works;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, todoschema_1.todolist.find({ userid: req.params.id })];
            case 1:
                works = _a.sent();
                if (works.length > 0) {
                    return [2 /*return*/, res.json({ success: true, works: works })];
                }
...
var createTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, todoschema_1.todolist.create(req.body)];
            case 1:
                _a.sent();
...
var deleteTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, todoschema_1.todolist.deleteOne({ _id: req.params.id })];
            case 1:
                _a.sent();
...
var updateTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, todoschema_1.todolist.updateOne({ _id: req.params.id }, { $set: { works: req.body.works } }, { new: true })];
            case 1:
                _a.sent();
